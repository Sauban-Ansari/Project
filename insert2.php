...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        header("Location: insert.php"); // Redirect back to form
        exit();
    }
}
?>
        ...
        <form action="insertcomp.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="hair_texture" name="hair_texture" class="form-control" required>
                    <option value="" disabled selected>Select hair texture</option>
            ...
            <div class="form-group">
                ...
                <select id="hair_condition" name="hair_condition" class="form-control" required>
                    <option value="" disabled selected>Select hair condition</option>
            ...
            <div class="form-group">
                ...
                <select id="dandruff" name="dandruff" class="form-control" required>
                    <option value="" disabled selected>Select as per choice</option>
